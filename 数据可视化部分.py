...
df_Played=pd.read_excel(open('PlayedData.xlsx','rb'))#从excel表格中读取数据，存入dataframe
...
df_total=df_total.sort_index(by='使用次数',ascending=False)#按照使用次数对数据进行降序排列
...
df_total=df_total.sort_index(by='伤害/分钟',ascending=False)  
...
subplots_adjust(left=0.0,bottom=0.0,top=1,right=3,hspace=0.5,wspace=0.1)
df_total=df_total.sort_index(by='胜率',ascending=False)  
tem=df_total['胜率'][:20]
...
subplots_adjust(left=0.0,bottom=0.0,top=1,right=3,hspace=0.5,wspace=0.1)
df_total=df_total.sort_index(by='使用次数',ascending=False)  
...
subplots_adjust(left=0.0,bottom=0.0,top=1,right=3,hspace=0.5,wspace=0.1)
df_total=df_total.sort_index(by='建筑伤害/分钟',ascending=False)  
...
subplots_adjust(left=0.0,bottom=0.0,top=1,right=3,hspace=0.5,wspace=0.1)
df_total=df_total.sort_index(by='经济/分钟',ascending=False)  
...
subplots_adjust(left=0.0,bottom=0.0,top=1,right=3,hspace=0.5,wspace=0.1)
df_total=df_total.sort_index(by='经验/分钟',ascending=False)  
...
subplots_adjust(left=0.0,bottom=0.0,top=1,right=3,hspace=0.5,wspace=0.1)
df_total=df_total.sort_index(by='伤害/经济',ascending=False)  
...
subplots_adjust(left=0.0,bottom=0.0,top=1,right=3,hspace=0.5,wspace=0.1)
df_total=df_total.sort_index(by='伤害/胜率',ascending=False)  
...
subplots_adjust(left=0.0,bottom=0.0,top=1,right=3,hspace=0.5,wspace=0.1)
df_total=df_total.sort_index(by='击杀/胜率',ascending=False)  
...
subplots_adjust(left=0.0,bottom=0.0,top=1,right=3,hspace=0.5,wspace=0.1)
df_total=df_total.sort_index(by='击杀',ascending=False)  
tem=df_total['击杀'][:20]
